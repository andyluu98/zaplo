...
const GH_RELEASES = 'https://github.com/andyluu98/zaplo/releases';
...
/** Trang GitHub repo */
export const GITHUB_URL = 'https://github.com/andyluu98/zaplo';

/** Windows — NSIS installer */
export const DOWNLOAD_FILENAME      = `Zaplo-Setup-${APP_VERSION}.exe`;
export const DOWNLOAD_URL           = `${GH_LATEST}/${DOWNLOAD_FILENAME}`;

/** macOS — Apple Silicon (M1/M2/M3) */
export const DOWNLOAD_FILENAME_MAC_ARM64 = `Zaplo-${APP_VERSION}-arm64.dmg`;
export const DOWNLOAD_URL_MAC_ARM64      = `${GH_LATEST}/${DOWNLOAD_FILENAME_MAC_ARM64}`;

/** macOS — Intel (x64) */
export const DOWNLOAD_FILENAME_MAC_X64 = `Zaplo-${APP_VERSION}.dmg`;
export const DOWNLOAD_URL_MAC_X64      = `${GH_LATEST}/${DOWNLOAD_FILENAME_MAC_X64}`;

/** Linux — AppImage (x64, works on any distro) */
export const DOWNLOAD_FILENAME_LINUX   = `Zaplo-${APP_VERSION}.AppImage`;
export const DOWNLOAD_URL_LINUX         = `${GH_LATEST}/${DOWNLOAD_FILENAME_LINUX}`;

/** Linux — .deb (Ubuntu/Debian) */
export const DOWNLOAD_FILENAME_LINUX_DEB = `Zaplo_${APP_VERSION}_amd64.deb`;
