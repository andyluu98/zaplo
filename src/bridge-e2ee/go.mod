...
// Pin qpack to v0.5.1 — the version github.com/imroc/req/v3 v3.56.0 (transitive
// HTTP/3 client) is written against. A newer transitive dep drifts qpack to
// v0.6.x which changed NewDecoder's signature and removed DecodeFull, breaking
// req's internal/http3 build on CI. Forcing v0.5.1 restores the known-good set.
