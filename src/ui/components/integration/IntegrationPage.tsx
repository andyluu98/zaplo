    ...
    return (
      <div className="flex flex-col h-full overflow-hidden bg-gray-900">
        ...
        <div className="flex-1 overflow-hidden flex items-center justify-center p-8">
          <div className="max-w-md text-center bg-gray-800/50 border border-gray-700 rounded-2xl px-8 py-10">
            <div className="text-4xl">🤖</div>
            <h3 className="text-white font-semibold mt-3">Trợ lý AI đã chuyển sang "AI &amp; Agent"</h3>
            <p className="text-gray-400 text-sm mt-2">Quản lý trợ lý AI (bộ não) + agent đăng bài/chat nay gom 1 chỗ ở mục <b>AI &amp; Agent</b> trên thanh bên.</p>
