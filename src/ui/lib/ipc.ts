...
declare global {
  interface Window {
    ...
    posting: {
      ...
      draftGenerate:  (params: { zaloId: string; pillarId: number; count: number; agentId?: number }) => Promise<{ success: boolean; ids?: number[]; error?: string }>;
      draftList:      (params: { zaloId: string; status?: string; agentId?: number }) => Promise<{ success: boolean; drafts: import('@/../../src/models/automation').ContentDraft[]; error?: string }>;
      ...
      draftDelete:    (params: { zaloId: string; id: number }) => Promise<{ success: boolean; error?: string }>;
      ...
      agentSave:      (params: { zaloId: string; agent: any }) => Promise<{ success: boolean; id?: number; error?: string }>;
      agentEnable:    (params: { id: number; enabled: boolean }) => Promise<{ success: boolean; error?: string }>;
      agentDelete:    (params: { id: number }) => Promise<{ success: boolean; error?: string }>;
      agentStatus:    (params: { id: number }) => Promise<{ success: boolean; status: any; error?: string }>;
      agentPostNow:   (params: { agentId: number; draftId?: number }) => Promise<{ success: boolean; ok?: boolean; sentCount?: number; total?: number; postedText?: string; error?: string }>;
      calendarList:   (params: { zaloId: string; ym: string }) => Promise<{ success: boolean; entries: any[]; error?: string }>;
      calendarAdd:    (params: { agentId: number; date: string; time: string }) => Promise<{ success: boolean; id?: number; error?: string }>;
